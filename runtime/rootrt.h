/*
 * root_lang runtime support library.
 *
 * Every program produced by the root_lang compiler includes this header and is
 * linked against rootrt.c. It provides text (string) handling, span (array)
 * helpers, buffered I/O and a small set of math/file utilities that the
 * standard module (root.rtl) exposes to user code.
 */
...
/*
 * `rt_print` chooses the correct output routine from the argument type. The
 * standard module binds root_lang's `emit` function to this macro.
 */
